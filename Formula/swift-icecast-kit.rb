...
# Homebrew formula for swift-icecast-kit
#
# Tap: atelier-socle/homebrew-tools
# Install: brew install atelier-socle/tools/swift-icecast-kit
...
class SwiftIcecastKit < Formula
  ...
  url "https://github.com/atelier-socle/swift-icecast-kit/archive/refs/tags/0.3.0.tar.gz"
  ...
  def install
    ...
    bin.install ".build/release/icecast-cli"
  end
