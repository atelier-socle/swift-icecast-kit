...
# Makefile — swift-icecast-kit
#
# Targets for building, testing, linting, formatting, and installing
# the icecast-cli CLI tool.

# ---------- Variables ----------

PREFIX       ?= /usr/local/bin
BINARY_NAME   = icecast-cli
...
coverage:
	...
	TEST_BIN=$$(find .build/debug -name "swift-icecast-kitPackageTests" -type f ! -name "*.o" -not -path "*.dSYM*" | head -1); \
...
help:
	@echo "swift-icecast-kit — Makefile targets"
	@echo ""
